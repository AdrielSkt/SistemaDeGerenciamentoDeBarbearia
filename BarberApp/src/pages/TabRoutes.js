...
export default function Routes({nomeCliente}){
  return(
    ...
    tabBarStyle: { 
      ...
      <Tab.Screen name="Menu" children={({navigation})=><Menu navigation={navigation} nomeCliente={nomeCliente}/>} options={{tabBarIcon: ({color, size})=> (<Entypo name="menu" color={color} size={size}/>)}}/>
